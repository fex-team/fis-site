...
> 强烈建议与[roadmap文档](http://fex.baidu.com/fis-site/docs/api/fis-conf.html#roadmap)对照阅读。
...
domain配置用于满足在代码部署上线时添加CDN或域名子目录需求，具体的使用方式可以参考[文档](http://fex.baidu.com/fis-site/docs/api/fis-conf.html#roadmapdomain)，本文将会主要介绍一下域名子目录为何需要使用domain来处理。
